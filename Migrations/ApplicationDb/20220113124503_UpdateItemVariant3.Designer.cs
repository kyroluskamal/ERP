...
namespace ERP.Migrations.ApplicationDb
{
    ...
    [Migration("20220113124503_UpdateItemVariant3")]
    partial class UpdateItemVariant3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Models.Items.Item_Per_MainCategory", b =>
                {
                    ...
                    b.HasKey("ItemId", "ItemMainCategoryId");

                    b.HasIndex("ItemMainCategoryId");

                    b.ToTable("Item_Per_MainCategory");
                });

            modelBuilder.Entity("ERP.Models.Items.Item_per_MainCategory_Per_SubCategory", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ItemMainCategoryId", "ItemId");

                    b.ToTable("Item_per_MainCategory_Per_SubCategory");
                });
            ...
            modelBuilder.Entity("ERP.Models.Items.ItemsVariant_RetailPrice", b =>
                {
                    ...
                    b.Property<string>("ModifiedBy_UserName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ERP.Models.Items.Item_per_MainCategory_Per_SubCategory", b =>
                {
                    b.HasOne("ERP.Models.Items.ItemSubCategory", "ItemSubCategory")
                        .WithMany("Item_per_MainCategory_Per_SubCategory")
                        .HasForeignKey("ItemSubCategoryId");

                    b.HasOne("ERP.Models.Items.Item_Per_MainCategory", "Item_Per_MainCategory")
                        .WithMany()
                        .HasForeignKey("ItemMainCategoryId", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Models.Items.ItemDescription", b =>
                {
                    b.HasOne("ERP.Models.Items.Item", "Item")
                        ...
                        .HasForeignKey("ERP.Models.Items.ItemDescription", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Models.Items.ItemNotes", b =>
                {
                    b.HasOne("ERP.Models.Items.Item", "Item")
                        .WithOne("ItemNotes")
                        .HasForeignKey("ERP.Models.Items.ItemNotes", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Models.Items.ItemsVariant_RetailPrice", b =>
                {
                    b.HasOne("ERP.Models.Items.ItemVariants", "ItemVariants")
                        .WithOne("ItemsVariant_RetailPrice")
                        .HasForeignKey("ERP.Models.Items.ItemsVariant_RetailPrice", "ItemVariantsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ERP.Models.Items.ItemVariant_WholeSalePrice", b =>
                {
                    b.HasOne("ERP.Models.Items.ItemVariants", "ItemVariants")
                        .WithOne("ItemVariant_WholeSalePrice")
                        .HasForeignKey("ERP.Models.Items.ItemVariant_WholeSalePrice", "ItemVariantsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
