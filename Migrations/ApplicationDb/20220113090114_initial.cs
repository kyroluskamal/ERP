        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MainCatName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSKUKeys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasNote = table.Column<bool>(type: "bit", nullable: false),
                    HasSKU_number = table.Column<bool>(type: "bit", nullable: false),
                    HasInternalNote = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_AspNetUsers_AddedBy_UserId",
                        column: x => x.AddedBy_UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CR = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "Date", nullable: false),
                    OpeningBalanceDate = table.Column<DateTime>(type: "Date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suppliers_AspNetUsers_AddedBy_UserId",
                        column: x => x.AddedBy_UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubCatName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlatNo = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    ...
                    Government = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    CountryName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CountryNameCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CountryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryAddresses_Inventories_InventoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InternalNotes_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Item_Per_MainCategory", x => new { x.ItemId, x.ItemMainCategoryId });
                    table.ForeignKey(
                        name: "FK_Item_Per_MainCategory_ItemMainCategories_ItemMainCategoryId",
                        column: x => x.ItemMainCategoryId,
                        principalTable: "ItemMainCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Item_Per_MainCategory_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Item_Units", x => new { x.ItemId, x.UnitsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemBrands", x => new { x.ItemId, x.BrandsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSuppliers", x => new { x.ItemId, x.SuppliersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "Item_per_MainCategory_Per_SubCategory",
                columns: table => new
                {
                    ItemMainCategoryId = table.Column<int>(type: "int", nullable: false),
                    ItemId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Item_per_MainCategory_Per_SubCategory", x => new { x.ItemId, x.ItemMainCategoryId });
                    table.ForeignKey(
                        name: "FK_Item_per_MainCategory_Per_SubCategory_Item_Per_MainCategory_ItemMainCategoryId_ItemId",
                        columns: x => new { x.ItemMainCategoryId, x.ItemId },
                        principalTable: "Item_Per_MainCategory",
                        principalColumns: new[] { "ItemId", "ItemMainCategoryId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Item_per_MainCategory_Per_SubCategory_ItemSubCategories_ItemSubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentNoInWarehouse = table.Column<int>(type: "int", nullable: false),
                    ...
                    ItemId = table.Column<int>(type: "int", nullable: false),
                    BrandsId = table.Column<int>(type: "int", nullable: false),
                    ItemSKU = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemVariants_ItemBrands_ItemId_BrandsId",
                        columns: x => new { x.ItemId, x.BrandsId },
                        principalTable: "ItemBrands",
                        principalColumns: new[] { "ItemId", "BrandsId" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ItemSKUkeys_Per_ItemVariants",
                columns: table => new
                {
                    ItemSKUKeysId = table.Column<int>(type: "int", nullable: false),
                    ItemVariantsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSKUkeys_Per_ItemVariants", x => new { x.ItemSKUKeysId, x.ItemVariantsId });
                    table.ForeignKey(
                        name: "FK_ItemSKUkeys_Per_ItemVariants_ItemSKUKeys_ItemSKUKeysId",
                        column: x => x.ItemSKUKeysId,
                        principalTable: "ItemSKUKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemSKUkeys_Per_ItemVariants_ItemVariants_ItemVariantsId",
                        column: x => x.ItemVariantsId,
                        principalTable: "ItemVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedBy_UserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItemVariantsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryAddresses_InventoriesId",
                table: "InventoryAddresses",
                column: "InventoriesId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Item_Per_MainCategory_ItemMainCategoryId",
                table: "Item_Per_MainCategory",
                column: "ItemMainCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Item_per_MainCategory_Per_SubCategory_ItemMainCategoryId_ItemId",
                table: "Item_per_MainCategory_Per_SubCategory",
                columns: new[] { "ItemMainCategoryId", "ItemId" });

            migrationBuilder.CreateIndex(
                name: "IX_Item_per_MainCategory_Per_SubCategory_ItemSubCategoryId",
                table: "Item_per_MainCategory_Per_SubCategory",
                column: "ItemSubCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemMainCategories_MainCatName",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemSKUkeys_Per_ItemVariants_ItemVariantsId",
                table: "ItemSKUkeys_Per_ItemVariants",
                column: "ItemVariantsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemSuppliers_SuppliersId",
                table: "ItemSuppliers",
                column: "SuppliersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemVariants_ItemId_BrandsId",
                table: "ItemVariants",
                columns: new[] { "ItemId", "BrandsId" });

            migrationBuilder.CreateIndex(
                name: "IX_ItemVariants_ItemSKU",
                table: "ItemVariants",
                column: "ItemSKU",
                unique: true,
                filter: "[ItemSKU] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_AddedBy_UserId",
                table: "Suppliers",
                column: "AddedBy_UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_BusinessName",
                table: "Suppliers",
                column: "BusinessName",
                unique: true);
